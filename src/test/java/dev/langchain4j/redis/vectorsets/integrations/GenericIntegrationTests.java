package dev.langchain4j.redis.vectorsets.integrations;
...
import dev.langchain4j.redis.vectorsets.Sentence;
...
public class GenericIntegrationTests implements AutoCloseable {
    ...
    public GenericIntegrationTests() throws JsonProcessingException {
        ...
        store = new RedisVectorSetEmbeddingStore(redisClient, "sentences");
        ...
        for (var sentence : randomSentences) {
            ...
            store.add(content, TextSegment.from(objectMapper.writeValueAsString(sentence)));
        }
    }
    ...
    public void withRedis() throws IOException {
        ...
        var first = result.matches().getFirst();
