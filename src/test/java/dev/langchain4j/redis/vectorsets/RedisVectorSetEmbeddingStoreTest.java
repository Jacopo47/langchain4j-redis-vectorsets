...
class RedisVectorSetEmbeddingStoreTest {

    private final Jedis redis;
    private final RedisVectorSetEmbeddingStore store;
    ...
    public RedisVectorSetEmbeddingStoreTest() {
        this.redis = mock(Jedis.class);

        this.store = new RedisVectorSetEmbeddingStore(redis, "sentences");
